...
GE_ROOT_DIR = SRC_DIR / "data_validation"
GE_BRONZE_ROOT_DIR = GE_ROOT_DIR / "great_expectations_bronze"
GE_SILVER_ROOT_DIR = GE_ROOT_DIR / "great_expectations_silver"
GE_GOLD_ROOT_DIR = GE_ROOT_DIR / "great_expectations_gold"
